...
namespace BookTimeOffBot.Bot

{
    public class BTO_Bot<T>:ActivityHandler where T : Dialog
    {
        ...
        public BTO_Bot(ConversationState conversationState,
                        UserState userState, T dialog,
                        ILogger<BTO_Bot<T>> logger)
        {
